          ...
          <div class="d-inline-flex">
            <a href="{{ route('products.show', $fav->favoriteable_id) }}" class="w-25">
              @if(App\Models\Product::find($fav->favoriteable_id)->image !== "")
                <img src="{{ asset(App\Models\Product::find($fav->favoriteable_id)->image) }}" class="img-fluid w-100" alt="">
              @else
            ...
            <div class="container mt-3">
              ...
              <h6 class="w-100 samuraimart-favorite-item-text">&yen;{{ App\Models\Product::find($fav->favoriteable_id)->price }}(税込)</h6>
            </div>
          </div>
        </div>
